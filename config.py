...
OWNER_ID = int(getenv("OWNER_ID", 6562419243)
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "DECENT_CHATTING")
UPDATE_CHNL = getenv("UPDATE_CHNL", "XD_N3TWORK")
OWNER_USERNAME = getenv("OWNER_USERNAME", "M3_4_U")
...
# Random Stickers
STICKER = [
    "CAACAgUAAxkBAAMvZYT_hNgsj6i1fK0niy5tXw1AdxoAAvQWAAIkUilUwbVmjX--qsUzBA",
    "CAACAgUAAxkBAAMzZYT_qjY-KstJIhyFdUBLcUK3P9YAAuYLAAL7HClUS0KpKc8Hd7keBA",
    "CAACAgUAAxkBAAM3ZYT_vAI1coARba_7hDyeRiP_Xh8AAjsPAAJomihUET5A0Rmue1AeBA",
]
